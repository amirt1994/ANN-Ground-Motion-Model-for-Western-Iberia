# -*- coding: utf-8 -*-
"""
Custom GMPE implementation for Taherian et al. 2024 - Inland scenarios.
"""
...
def calculate_psa_TEA24_inland(Mw, Rjb, Depth, FM):
    """
    Calculate PSA for inland scenarios using TEA24 model.
    ...
    # Load model properties and scalers
    ...
    # Reshape inputs to 2D for the scaler
...
class Taherian2024Inland(GMPE):
    """
    Implements the Taherian et al. 2024 GMPE for Inland scenarios.
    """
    ...
    def compute(self, ctx: np.recarray, imts, mean, sig, tau, phi):
        ...
        print(f"Taherian 2024 Inland - Successfully computed for periods: {', '.join([str(imt.string) for imt in imts])}")
