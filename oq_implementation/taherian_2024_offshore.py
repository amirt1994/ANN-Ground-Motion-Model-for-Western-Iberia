# -*- coding: utf-8 -*-
"""
Custom GMPE implementation for Taherian et al. 2024 - Offshore scenarios.
"""
...
def calculate_psa_TEA24_offshore(Mw, Rjb, Depth, FM):
    """
    Calculate PSA for offshore scenarios using TEA24 model.
...
class Taherian2024Offshore(GMPE):
    ...
    def compute(self, ctx: np.recarray, imts, mean, sig, tau, phi):
        ...
        print(f"Taherian 2024 Offshore - Successfully computed for periods: {', '.join([str(imt.string) for imt in imts])}")
